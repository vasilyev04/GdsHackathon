...
class MainViewModel(application: Application): ViewModel() {
    ...
    companion object{
        private const val PROMPT = "1.Океанариум «Ailand»:\n" +
                ...
                "\n" +
                "Помимо этого в каждом запросе ты будешь иметь локацию пользователя в виде \"USER_LOCATION: Latitude Longitude\", отталкивайся от нее, чтобы советовать достопримечательность, но пользователь не должен видеть эту информацию." + "\nНе используй звездочки в своих ответах (*)!!!!"
    }
